...
Local setup is covered in the [README Quick Start](https://github.com/nadmax/socle/blob/master/README.md#quick-start). Follow those instructions to get the project building and the database running before working on anything else.
